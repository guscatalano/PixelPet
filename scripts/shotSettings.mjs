...
app.whenReady().then(async () => {
  ipcMain.handle('settings:get', () => ({ activePetId: 'tiger', scale: 5, overrides: {} }))
  ...
  if (process.env.SCROLL) await win.webContents.executeJavaScript('window.scrollTo(0, document.body.scrollHeight)')
