...
const NORMAL = {}
const CHONKY = { bodyRx: 14, bodyRy: 12, headRx: 11.5, headRy: 10.5 }
const SLIM = { bodyRx: 10.5, bodyRy: 10, headRx: 10.5, headRy: 9.5 }
const KITTEN = { headRx: 12, headRy: 11, bodyRx: 10.5, bodyRy: 9, eyeRx: 2.9, eyeRy: 3.4, eyeDX: 5.4, earW: 8, noseY: 22 }
const FLUFFY = { earH: 10.5, cheekFluff: 4.5, bodyRx: 13.5, bodyRy: 11.5 }
const BIGEARS = { earH: 11.5, earW: 8.5, earSpread: 8 }

const g = (arch, extra = {}) => ({ ...arch, ...extra })

export const PRESETS = [
  { id: 'snowbell', name: 'Snowbell', blurb: 'A serene, cloud-soft house cat.',
    geom: g(NORMAL), marking: 'solid',
    coat: { primary: '#f2f2f4', iris: '#5cbf74' },
  ...
  { id: 'ash', name: 'Ash', blurb: 'A classic mackerel gray tabby.',
    geom: g(NORMAL), marking: 'tabby',
